 ...
 * @uses jin_admin_header_style()
 * @uses jin_admin_header_image()
 */
function jin_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'jin_custom_header_args', array(
		...
		'admin-preview-callback' => 'jin_admin_header_image',
	) ) );
}
...
if ( ! function_exists( 'jin_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see jin_custom_header_setup().
 */
function jin_admin_header_style() {
?>
	<style type="text/css">
...
endif; // jin_admin_header_style

if ( ! function_exists( 'jin_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see jin_custom_header_setup().
 */
function jin_admin_header_image() {
?>
	<div id="headimg">
